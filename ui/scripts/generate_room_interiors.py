#!/usr/bin/env python3
"""Generate dense cyber-arcane room interiors (96×96), agents (32×32), floor, furniture.

Palette-locked, nearest-neighbor friendly for Phaser pixelArt.
Furniture is baked into room tiles; agents are separate overlays.
"""
