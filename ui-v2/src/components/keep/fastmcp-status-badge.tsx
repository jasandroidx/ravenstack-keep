...
export function FastMCPStatusBadge() {
  ...
  return (
    ...
    >
      ...
      {/* Hover Card Details */}
      <div className="pointer-events-none absolute right-0 top-full z-50 mt-1 hidden w-72 flex-col gap-1 rounded-sm border border-[#3a3f4b] bg-[#0b0e14]/95 p-3 text-[10px] text-[#e8ecf1] shadow-2xl backdrop-blur-xl group-hover:flex group-focus:flex group-focus-visible:flex">
