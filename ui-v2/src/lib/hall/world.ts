...
export const HALL_NPCS: HallNpc[] = [
  {
    id: "gallery-arch",
    name: "To The Grand Gallery",
    role: "Portal",
    x: 640,
    y: 270,
    radius: 60,
    state: "idle",
    greeting: "The stone archway leads into The Grand Gallery — where Maestro Ross holds the cyber-arcane studio and hung portraits of the Keep.",
    href: "/gallery",
    actions: [
